...
# When parameters are needed for a model with constant transmission parameter then 
# it is more convenient not to need to enter values for A and δ. Equally, if no 
# non-pharmaceutical interventions are simulated, do not need to provide βreduction1 
# or βreduction2 explicitly

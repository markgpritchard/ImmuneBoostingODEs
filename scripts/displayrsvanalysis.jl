...
chain_omega_01 = load(datadir("sims", "chain_omega_0.1_nrounds_100.jld2"))
...
chain_omega_02 = load(datadir("sims", "chain_omega_0.2_nrounds_100.jld2"))
...
chain_omega_04 = load(datadir("sims", "chain_omega_0.4_nrounds_100.jld2"))
...
chain_omega_1 = load(datadir("sims", "chain_omega_1.0_nrounds_100.jld2"))
...
chain_omega_2 = load(datadir("sims", "chain_omega_2.0_nrounds_100.jld2"))
chain_omega_2df = DataFrame(chain_omega_2["chain"])
plotchains(chain_omega_2df)
plotvals2 = fittedsimulationquantiles(
    chain_omega_2df, 2.0, saveat, cbs, [ 0.025, 0.5, 0.975 ]
)

chain_omega_4 = load(datadir("sims", "chain_omega_4.0_nrounds_100.jld2"))
...
chain_omega_6 = load(datadir("sims", "chain_omega_6.0_nrounds_100.jld2"))
